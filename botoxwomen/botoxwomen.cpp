// botoxwomen.cpp : Definiert den Einstiegspunkt für die Anwendung.
//

#include "stdafx.h"
#include "botoxwomen.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_BOTOXWOMEN, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_BOTOXWOMEN));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_BOTOXWOMEN));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_BOTOXWOMEN);
